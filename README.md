...
<head>
  <meta charset="UTF-8">
  <title>Por que o MERCOSUL não deu certo </title>
  <style>
    body {
      display: flex;
...
<body>
  <div class="fake-video" onclick="window.location.href='[https://youtu.be/y9Auure3h4A?si=KpFHMSEyZ4EiOk3](https://youtu.be/y9Auure3h4A?si=KpFHMSEyZ4EiOk3L
)'">
